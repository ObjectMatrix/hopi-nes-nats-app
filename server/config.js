...
module.exports = {
  ...
  auth: {
    ...
    github: {
      ...
      isSecure: false, //process.env.CHAT_APP_AUTH_GITHUB_ISSECURE || false,
      clientId: '123456', //process.env.CHAT_APP_AUTH_GITHUB_CLIENTID || '', // You can aquire this here: https://github.com/settings/applications/new
      clientSecret: process.env.CHAT_APP_AUTH_GITHUB_CLIENTSECRET || '', // same as above
      forceHttps: process.env.NODE_ENV === 'development' ? false : true
    },
    cookie: {
